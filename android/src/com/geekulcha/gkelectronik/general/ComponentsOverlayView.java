...
import com.geekulcha.gkelectronik.R;
...
public class ComponentsOverlayView extends RelativeLayout
{
    public ComponentsOverlayView(Context context)
    {
        this(context, null);
    }
    
    
    public ComponentsOverlayView(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }
    
    
    public ComponentsOverlayView(Context context, AttributeSet attrs, int defStyle)
    {
